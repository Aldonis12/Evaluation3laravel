                                    ...
                                    <div class="card-body">
                                        <form action="/@php echo($url) @endphp" method="POST">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="date" name="dtn" max="{{date('Y-m-d')}}" value="{{ $Patient->dtn }}" class="form-control" required>
                                                </div>
                                            </div>
                                        ...
                                        @endphp
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" name="nom" value="{{ $Acte->nom }}" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <label>Budget</label>
                                                        <input type="number" step="any" name="budget" value="{{$Acte->budget}}" class="form-control" required>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <label>CODE</label>
                                                        <input type="text" name="code" maxlength="3" value="{{$Acte->code}}" class="form-control" required>
                                                    </div>
                                                </div>
                                        @php
                                        }
                                        ...
                                        @endphp
                                            ...
                                            <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <label>Budget</label>
                                                        <input type="number" step="any" name="budget" value="{{ $Depense->budget }}" class="form-control" required>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <label>CODE</label>
                                                        <input type="text" name="code" maxlength="3" value="{{ $Depense->code }}" class="form-control" required>
                                                    </div>
                                                </div>
                                        @php
                                        }
